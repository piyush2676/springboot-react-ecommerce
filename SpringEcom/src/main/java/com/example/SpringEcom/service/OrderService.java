    ...
    public OrderResponse placeOrder(OrderRequest request) {
        ...
        for(OrderItemRequest itemReq: request.items()){
            ...
            OrderItem orderItem = OrderItem.builder()
                    .product(product).quantity(itemReq.quantity()).totalPrice(product.getPrice().multiply(
                            BigDecimal.valueOf(itemReq.quantity()))).order(order)
                    .build();
        ...
        OrderResponse orderResponse = new OrderResponse(savedOrder.getOrderId()
                , savedOrder.getCustomerName(), savedOrder.getEmail(),
